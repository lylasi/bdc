...
export const ocrStopBtn = document.getElementById('ocr-stop-btn');
...
export const ocrResultPreview = document.getElementById('ocr-result-preview');
export const ocrDisplayMode = document.getElementById('ocr-display-mode');
